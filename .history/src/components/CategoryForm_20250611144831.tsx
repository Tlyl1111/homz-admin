...
export const CategoryForm = ({ category, onClose, onSave }: CategoryFormProps) => {
  ...
  const handleImageUpload = async (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    form.append("upload_preset", "homz"); // Replace with your actual preset
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (category) {
        ...
        // Thêm mới - loại bỏ mọi ID thủ công để tránh lỗi trùng khóa chính
        const { name, iconPath } = formData;
        result = await supabase
          .from("Categories")
